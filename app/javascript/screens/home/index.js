      ...
      <Columns>
        <Columns.Column>
          <MainHeading className='has-text-weight-light has-text-centered has-text-white' size={1}>
            SEU APP DE <br /><span className='has-text-info'>MÚSICA</span>
          </MainHeading>
        </Columns.Column>
      </Columns>
      <Columns className="is-centered is-mobile">
        <Columns.Column mobile={{ size: 8, offset: 1 }} desktop={{ size: 4, offset: 2 }}>
              ...
              <DescriptionList className='has-text-white'>
                  <li>Suas musicas <b>Favoritas</b></li>
                  <li>Seus <b>Podcasts</b></li>
                  <li>Os <b>Lancamentos</b></li>
      ...
      <Columns className="has-text-centered">
        <Columns.Column>
          <a href='users/sign_up'>
            <ButtonSubscribe className='is-info is-outlined is-large has-text-white'>CADASTRAR AGORA</ButtonSubscribe>
          </a>
        </Columns.Column>  
      </Columns>
    </SectionWrapper>
